...
<!--                        </ul>-->
                ...
                <div id="sitemap-main" style="display: block; float: left; width: 180px; margin: 30px">
                    <h4>Sitemap</h4>
                    <ul>
                        <?php wp_nav_menu( array( 'depth' => 1, 'sort_column' => 'menu_order', 'container' => 'ul', 'theme_location' => 'primary-menu' ) );//wp_list_pages( 'sort_column=menu_order&depth=1&title_li=&exclude=' ); wp_ ?>
                    </ul>
                </div>
            </div>
			...
			<div id="footer-right" class="col-right">
				<div class="block" style="margin: 30px 30px 20px 0;">
                    ...
                    <iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2FSrikrungShop&amp;width=292&amp;height=210&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;show_border=true&amp;header=true&amp;appId=193435037371900" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:292px; height:210px;" allowTransparency="true"></iframe>
				</div>
			</div>
