...
"type" => "layerslider",
"std" => 1,
"options" => get_layerslider(),
"description" => "select a slider",
"title" => "LayerSlider");
}
...
"type" => "unoslider",
"std" => 1,
"options" => get_unoslider(),
"description" => "select a slider",
"title" => "UnoSlider");
}

if(get_layerslider()){
$select_type_layerslider = array( "value" => "layerslider", "text" => "LayerSlider");
}else{
$select_type_layerslider = array( "value" => "layerslider-none", "text" => "LayerSlider is not available now");   
}

if(get_unoslider()){
$select_type_unoslider = array( "value" => "unoslider", "text" => "UnoSlider");
}else{
$select_type_unoslider = array( "value" => "unoslider-none", "text" => "UnoSlider is not available now");   
}
...
"type" => "select",
"std" => 1,
"options" => array (array( "value" => "", "text" => "None"),
                    $select_type_unoslider,
                    $select_type_layerslider,
