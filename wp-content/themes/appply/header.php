    ...
    <div id="top-login-bar-wrapper">
        <div style="display: inline-block; padding: 2px;">
            ...
            <form action="./wp-login.php" method="post" id="form-login-bar">
                ...
                <input type="image" class="submit-btn" style="vertical-align: bottom" src="<?php echo esc_url(get_template_directory_uri() . '/images/buttons/apple_member.png'); ?>" onclick="window.location.href = 'wp-signup.php';"/>
            <?php else :?>
