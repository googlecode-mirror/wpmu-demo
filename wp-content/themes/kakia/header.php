				...
				<div id="menu_wrapper">
					...
					<div id="top_bar">
						...
						<div class="top_bar_wrapper">
							<noscript><a href="http://www.vectors4all.com/popular-vectors">Best vectors</a></noscript>
				    ...
				    <div id="menu_border_wrapper">
                        ...
                        <div class="menu-main-menu-container">
                            <ul id="main_menu" class="nav"><?php wp_list_pages( 'sort_column=menu_order&depth=6&title_li=&exclude=' ); ?></ul>
                        </div>
				        <?php } ?>
