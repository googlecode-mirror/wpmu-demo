...
function add_button() {  
    ...
    add_filter('mce_buttons_4', 'register_portfolio');
    add_filter('mce_buttons_4', 'register_pricing');
    add_filter('mce_buttons_4', 'register_content');
	}  
}  
...
function register_portfolio($buttons) {   	
