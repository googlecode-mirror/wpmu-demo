...
require_once (OF_FILEPATH . '/functions/breadcrumbs.php');
...
function on_admin_init() {
    // include the library
    require_once (OF_FILEPATH . '/admin/envato-wordpress-toolkit-library/class-envato-wordpress-theme-upgrader.php');
    
    $themeforest_username = get_option('corbiz_themeforest_username');
    $themeforest_api_key = get_option('corbiz_themeforest_username');
