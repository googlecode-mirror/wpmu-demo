...
function theme_add_shortcode_tinymce_plugin($plugin_array) {
	global $theme;
	$plugin_array['ThemeShortcodes'] = get_bloginfo( 'template_url' ) .'/admin/js/editor_plugin.js';
	return $plugin_array;
}
...
function theme_admin_menu_styles() {
	global $theme;
	wp_enqueue_style( 'theme_admin_menu_styles', get_bloginfo( 'template_url' ) . '/admin/css/tinymce.css' );
}
