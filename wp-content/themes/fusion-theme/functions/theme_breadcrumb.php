...
if ( function_exists( 'get_option_tree') ) {
	...
	if (is_single()) {
        ...
        echo "<span class='current'>";
        if ( is_day() ) :
            printf( get_the_date( _x( 'j M Y', 'daily archives date format' )));
        elseif ( is_month() ) :
            printf( get_the_date( _x( 'F Y', 'monthly archives date format' )));
        elseif ( is_year() ) :
            printf( get_the_date( _x( 'Y', 'yearly archives date format'))); 
        else : 
        ...
        if(is_author()){
            ...
            _e( '&nbsp;&rarr; Portfolio Category', GETTEXT_DOMAIN);
            echo "&nbsp;&rarr; <span class='current'>";
            echo get_queried_object()->name;
            echo "</span>";
        }elseif (is_tax('portfolio_tags')) {
            _e( '&nbsp;&rarr; Portfolio Tag', GETTEXT_DOMAIN);
            echo "&nbsp;&rarr; <span class='current'>";
            echo get_queried_object()->name;
            echo "</span>";
        } 
